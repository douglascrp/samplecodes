...
var query = '(@cm\\:owner:"'+ userName +'" AND TYPE:"{http://www.alfresco.org/model/content/1.0}content") OR (-@cm\\:owner AND @cm\\:creator:"'+ userName +'" AND TYPE:"{http://www.alfresco.org/model/content/1.0}content")';
